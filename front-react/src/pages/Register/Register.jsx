  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white">
      ...
      className="w-full max-w-sm bg-white p-8 rounded shadow">
        <h2 className="text-center font-bold">학생 회원가입</h2>
        ...
        <label className="block mb-2 text-gray-700 text-sm font-bold">이메일:</label>
        <input type="email" name="email" placeholder="이메일" onChange={handleChange} required className="w-full mb-4 px-4 py-2 border rounded focus:outline-none focus:ring-2"/>
        <label className="block mb-2 text-gray-700 text-sm font-bold">전화번호:</label>
        <input type="text" name="phone" placeholder="전화번호" onChange={handleChange} required className="w-full mb-4 px-4 py-2 border rounded focus:outline-none focus:ring-2"/>
        <label className="block mb-2 text-gray-700 text-sm font-bold">주소:</label>
        <input type="text" name="address" placeholder="주소" onChange={handleChange} required className="w-full mb-4 px-4 py-2 border rounded focus:outline-none focus:ring-2"/>
